...
5. Copy config.dist.php to config.php and open the config.php with your convenient editor, change host, port, admins and so on to yours
...
--------------------------------------
1.Copy config.php from your old to your new version directory
2.Done!
