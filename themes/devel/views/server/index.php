...
<table bgcolor="#cccccc" cellpadding="2" cellspacing="1" width="600">
	<tr>
		<th colspan="2"><a href="http://www.mongodb.org/display/DOCS/Command+Line+Parameters" target="_blank"><?php hm(
					"command_line"
				); ?></a> (db.serverCmdLineOpts())
		</th>
	</tr>
	<tr bgcolor="#fffeee">
...
<table bgcolor="#cccccc" cellpadding="2" cellspacing="1" width="600">
	<tr>
		<th colspan="3"><a href="http://us.php.net/manual/mongo.configuration.php" target="_blank"><?php hm(
					"directives"
				); ?></a></th>
	</tr>
	<tr bgcolor="#fffeee">
