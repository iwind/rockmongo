...
<div>
	<form method = "post">
		...
		<select name = "level" onchange = "changeLevel(this)">
			<option value = "0" <?php if ($level == 0): ?>selected="selected"<?php endif;?>><?php echo hm("profiling_level1"); ?>
				:
			</option>
		...
		<div id = "slowmsDiv" style = "display:none">
			<?php echo hm("timecost"); ?> &gt;
			<input type = "text" name = "slowms" size = "7" value = "<?php h(xi("slowms"));?>"/> ms
		</div>
