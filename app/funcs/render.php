...
{
	$items = array('<a href="http://docs.mongodb.org/manual/reference/operators/" target="_blank">' . rock_lang("querying") . '</a>', '<a href="http://docs.mongodb.org/manual/applications/update/" target="_blank">' . rock_lang("updating") . '</a>', '<a href="http://docs.mongodb.org/manual/reference/command/" target="_blank">' . rock_lang("commands") . '</a>', '<a href="http://api.mongodb.org/js/" target="_blank">' . rock_lang("jsapi") . '</a>', '<a href="http://www.php.net/manual/en/book.mongo.php" target="_blank">' . rock_lang("phpmongo") . '</a>');
...
{
	$menuItems = array(array("action" => "server.index", "name" => rock_lang("server")), array("action" => "server.status", "name" => rock_lang("status")), array("action" => "server.databases", "name" => rock_lang("databases")), array("action" => "server.processlist", "name" => rock_lang("processlist")), array("action" => "server.command", "params" => array("db" => xn("db")), "name" => rock_lang("command")), array("action" => "server.execute", "params" => array("db" => xn("db")), "name" => rock_lang("execute")), array("action" => "server.replication", "name" => rock_lang("master_slave")),);
...
{
	$menuItems = array(array("action" => "db.index", "params" => array("db" => $dbName), "name" => rock_lang("statistics")), array("action" => "db.newCollection", "params" => array("db" => $dbName), "name" => rock_lang("create_collection")), array("action" => "server.command", "params" => array("db" => $dbName), "name" => rock_lang("command")), array("action" => "server.execute", "params" => array("db" => $dbName), "name" => rock_lang("execute")), array("action" => "db.dbTransfer", "params" => array("db" => $dbName), "name" => rock_lang("transfer")), array("action" => "db.dbExport", "params" => array("db" => $dbName, "can_download" => 1), "name" => rock_lang("export"), "can_download" => 1), array("action" => "db.dbImport", "params" => array("db" => $dbName), "name" => rock_lang("import")), array("action" => "db.profile", "params" => array("db" => $dbName), "name" => rock_lang("profile")), array("action" => "db.repairDatabase", "params" => array("db" => $dbName), "name" => rock_lang("repair"), "attr.onclick" => "return window.confirm('" . rock_lang("repairdbmsg") . " {$dbName}?');"), array("action" => "db.auth", "params" => array("db" => $dbName), "name" => rock_lang("authentication")), array("action" => "db.dropDatabase", "params" => array("db" => $dbName), "name" => rock_lang("drop"), "attr.onclick" => "return window.confirm('" . rock_lang("dropwarning") . " " . $dbName . "? " . rock_lang("dropwarning2") . "');"));
...
{
	$types = array("integer" => "Integer", "long" => "Long", "double" => "Double", "string" => "String", "boolean" => "Boolean", "null" => "NULL", "mixed" => "Mixed");
